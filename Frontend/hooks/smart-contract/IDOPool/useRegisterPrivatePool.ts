...
export const useRegisterPrivatePool = ({
  chainId,
  // <---! CONTRACT PROPS IN ABI STARTS HERE !---> //
  poolAddress,
  // <---! CONTRACT PROPS IN ABI STARTS HERE !---> //
  ...
  const CONTRACT_LABEL = "Register Private Pool";
  const FUNCTION_EXECUTION_NAME = "onRegisterPrivatePool";
  ...
  const onRegisterPrivatePool = async () => {
